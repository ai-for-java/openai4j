...
public abstract class OpenAiClient {
  ...
  public abstract SyncOrAsync<EmbeddingResponse> embedding(
    EmbeddingRequest request
  );

  public abstract SyncOrAsync<List<Float>> embedding(String input);

  public abstract SyncOrAsync<ModerationResponse> moderation(
  ...
  public static OpenAiClient.Builder builder() {
    for (OpenAiClientBuilderFactory factory : ServiceHelper.loadFactories(
      OpenAiClientBuilderFactory.class
    )) {
      return factory.get();
    }
  ...
  public abstract static class Builder<
    T extends OpenAiClient, B extends Builder<T, B>
  > {
    ...
    public B azureApiKey(String azureApiKey) {
      if (azureApiKey == null || azureApiKey.trim().isEmpty()) {
        throw new IllegalArgumentException(
          "azureApiKey cannot be null or empty"
        );
      }
